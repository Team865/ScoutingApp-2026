...
export default class AverageBlock extends OperatorBlock {
    ...
    public constructor(slots?: BlockSlot[]) {
        ...
        this.textLabel.innerText = "AVERAGE OF";
    ...
    public override getValueForTeam(teamNumber: number) {
        ...
        return array.reduce((partialSum, value) => partialSum + value, 0) / array.length;
    }

    public override clone(): AverageBlock {
        return new AverageBlock(this.cloneSlots());
    }
}