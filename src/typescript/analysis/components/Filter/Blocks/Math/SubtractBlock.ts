...
export default class SubtrackBlock extends OperatorBlock {
    ...
    public constructor(setSelectedBlock: SetSelectedBlock, slots?: BlockSlot[]) {
        ...
        this.textLabel.innerText = "MINUS";
    ...
    override clone(): SubtrackBlock {
        return new SubtrackBlock(this.setSelectedBlock, this.cloneSlots());
    }
}