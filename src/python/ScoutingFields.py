...
class _QuantitativeScoutingFields_F0(TypedDict):
	name: Literal['Text Field']
	type: Literal['TEXT']
class _QuantitativeScoutingFields_F1(TypedDict):
	name: Literal['Number Field']
	type: Literal['NUMBER']
class _QuantitativeScoutingFields_F2(TypedDict):
	name: Literal['Number Range Field']
	type: Literal['NUMBER_RANGE']
	min: Literal[0]
	max: Literal[5]
class _QuantitativeScoutingFields_F3(TypedDict):
	name: Literal['Single Choice Field']
	type: Literal['SINGLE_CHOICE']
	choices: tuple[Literal['Test'], Literal['Test 2']]
type QuantitativeScoutingFields_t = tuple[_QuantitativeScoutingFields_F0, _QuantitativeScoutingFields_F1, _QuantitativeScoutingFields_F2, _QuantitativeScoutingFields_F3]
QuantitativeScoutingFields: tuple[FieldConfig, ...] = ({'name': 'Text Field', 'type': 'TEXT'}, {'name': 'Number Field', 'type': 'NUMBER'}, {'name': 'Number Range Field', 'type': 'NUMBER_RANGE', 'min': 0, 'max': 5}, {'name': 'Single Choice Field', 'type': 'SINGLE_CHOICE', 'choices': ('Test', 'Test 2')})
...
PitScoutingFields: tuple[FieldConfig, ...] = ({'name': 'Drivetrain', 'type': 'SINGLE_CHOICE', 'choices': ('Swerve', 'Westcoast', 'Mechanum', 'Kitbot')}, {'name': 'Robot Size', 'type': 'TEXT', 'isOptional': True}, {'name': '/w Bumpers?', 'type': 'BOOLEAN'}, {'name': 'Coral Scoring Locations', 'type': 'MULTIPLE_CHOICE', 'choices': ('L1', 'L2', 'L3', 'L4')}, {'name': 'Driveteam Experience', 'type': 'TEXT'}, {'name': 'Mechanical Rating', 'type': 'NUMBER_RANGE', 'min': 0, 'max': 10}, {'name': 'Electrical Rating', 'type': 'NUMBER_RANGE', 'min': 0, 'max': 10})