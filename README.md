...
9. Get a TBA API key or set up an API key on TBA to use TBA data for teams. Store the key in a `.env` file in the root directory. Your file should look like the following:
```
